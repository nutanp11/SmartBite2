export default [
    {
      ...
      name: "The Bawarchi",
      cuisines: "North Indian, Chinese, Biryani, Rolls, Momos, Sichuan",
      average_cost_for_two: 1600,
      aggregate_rating: 4.3,
      adress: "Mango, Jamshedpur",
      smalladress: "Mango, Jamshedpur",
      offer: "₹80 OFF",
      no_of_Delivery: 1500,
      latitude: 12.9916,
      longitude: 77.5712,
  ...
  
    {
      ...
      adress:
        "C-7, Vishal Enclave, Opposite Metro Pillar 417, Rajouri Garden, Jamshedpur",
      smalladress: "Bistupur,Jamshedpur",
      offer: "₹80 OFF",
      no_of_Delivery: 2500,
      latitude: 12.9716,
      longitude: 77.5946,
